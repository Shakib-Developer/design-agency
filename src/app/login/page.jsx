        ...
        <div className="min-w-fit flex-col  bg-white px-6 py-14 shadow-md rounded-xl ">
          ...
          <form onSubmit={handelSubmit}>
            <div className="flex flex-col text-sm rounded-md">
              <input
                className="mb-5 text-black rounded-[4px] border p-3 hover:outline-none focus:outline-none hover:border-yellow-500 "
                type="email"
                placeholder="Email id"
                ref={(input) => (emailRef = input)}
              />
              <input
                className="border text-black rounded-[4px] p-3 hover:outline-none focus:outline-none hover:border-yellow-500"
                type="password"
